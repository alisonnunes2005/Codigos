...
function gr(e, n, t, r, l) {
    ...
    if (u)
        ...
        gr(l, n, t, "", function(c) {
            return c
        })) : l != null && (Bo(l) && (l = hc(l, t + (!l.key || u && u.key === l.key ? "" : ("" + l.key).replace(Iu, "$&/") + "/") + e)),
        n.push(l)),
        1;
    if (u = 0,
    r = r === "" ? "." : r + ":",
        ...
        if (z !== N) {
            ...
            e: for (var H = 0, X = C.length, bt = X >>> 1; H < bt; ) {
                var vn = 2 * (H + 1) - 1
                  ...
                  , er = C[yn];
                if (0 > l(gl, z))
                    yn < X && 0 > l(er, gl) ? (C[H] = er,
                    C[yn] = z,
                    H = yn) : (C[H] = gl,
                    C[vn] = z,
                    H = vn);
                else if (yn < X && 0 > l(er, z))
                    C[H] = er,
                    C[yn] = z,
                    H = yn;
                else
...
var We = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u")
  ...
  , Uu = {};
function zc(e) {
    return Kl.call(Uu, e) ? !0 : Kl.call(ju, e) ? !1 : Nc.test(e) ? Uu[e] = !0 : (ju[e] = !0,
    !1)
}
function Lc(e, n, t, r) {
    if (t !== null && t.type === 0)
...
var Cs = ve.unstable_scheduleCallback
  ...
  , Bc = ve.unstable_requestPaint
  , W = ve.unstable_now
  , Hc = ve.unstable_getCurrentPriorityLevel
  , Zo = ve.unstable_ImmediatePriority
  , _s = ve.unstable_UserBlockingPriority
  , Or = ve.unstable_NormalPriority
  , Wc = ve.unstable_LowPriority
...
var zs, qo, Ls, Ts, Rs, ao = !1, ir = [], tn = null, rn = null, ln = null, Dt = new Map, Ft = new Map, qe = [], qc = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function Yu(e, n) {
    switch (e) {
    case "focusin":
    case "focusout":
...
function bc(e, n, t, r, l) {
    ...
    case "pointerover":
        var o = l.pointerId;
        return Dt.set(o, ft(Dt.get(o) || null, e, n, t, r, l)),
        !0;
    case "gotpointercapture":
        return o = l.pointerId,
        Ft.set(o, ft(Ft.get(o) || null, e, n, t, r, l)),
        !0
    }
    return !1
}
...
function ri() {
    _t && (_t.detachEvent("onpropertychange", As),
    jt = _t = null)
}
function As(e) {
...
function Of(e, n, t) {
    ...
    _t = n,
    jt = t,
    _t.attachEvent("onpropertychange", As)) : e === "focusout" && ri()
}
function Df(e) {
...
function $t(e) {
    if (!e[cr]) {
        ...
        rs.forEach(function(t) {
            t !== "selectionchange" && (Bf.has(t) || Ol(t, !1, e),
            Ol(t, !0, e))
        });
    ...
    ws(function() {
        ...
        if (!(n & 7)) {
            ...
            if (ru)
                ...
                Fn ? Is(e, t) && (P = "onCompositionEnd") : e === "keydown" && t.keyCode === 229 && (P = "onCompositionStart");
            P && (Fs && t.locale !== "ko" && (Fn || P !== "onCompositionStart" ? P === "onCompositionEnd" && Fn && (x = Ds()) : (en = h,
            ...
            x ? P.data = x : (x = js(t),
            x !== null && (P.data = x)))),
            (x = Nf ? zf(e, t) : Lf(e, t)) && (c = jr(c, "onBeforeInput"),
...
function ai(e, n, t, r, l) {
    for (var o = n._reactName, u = []; t !== null && t !== r; ) {
        ...
        i.tag === 5 && c !== null && (i = c,
        l ? (s = Ot(t, o),
        s != null && u.unshift(At(t, s, i))) : l || (s = Ot(t, o),
    ...
    if (j) {
        ...
        if (n) {
            ...
            if (!hi(e, n)) {
                ...
                n = on(t.nextSibling);
                var r = he;
                n && hi(e, n) ? ea(r, t) : (e.flags = e.flags & -4097 | 2,
                j = !1,
                he = e)
            }
        } else {
...
function dr(e) {
    ...
    e.tag === 13) {
        ...
        me = he ? on(e.stateNode.nextSibling) : null;
    return !0
}
function na() {
    for (var e = me; e; )
...
function oa(e, n, t) {
    var r = !1
      , l = dn
      , o = n.contextType;
    return typeof o == "object" && o !== null ? o = Ce(o) : (l = fe(n) ? xn : re.current,
    r = n.contextTypes,
...
function _o(e, n, t, r) {
    ...
    du(e);
    var o = n.contextType;
    typeof o == "object" && o !== null ? l.context = Ce(o) : (o = fe(n) ? xn : re.current,
    l.context = qn(e, o)),
    l.state = e.memoizedState,
...
function ua(e) {
    ...
    function s(f, a, d, v) {
        var E = d.type;
        return E === Dn ? h(f, a, d.props.children, v, d.key) : a !== null && (a.elementType === E || typeof E == "object" && E !== null && E.$$typeof === Ze && ki(E) === a.type) ? (v = l(a, d.props),
        v.ref = mt(f, a, d),
        v.return = f,
    ...
    function h(f, a, d, v, E) {
        return a === null || a.tag !== 7 ? (a = _n(d, f.mode, v, E),
        a.return = f,
        a) : (a = l(a, d),
        a.return = f,
        a)
...
function Li(e, n, t, r, l) {
    ...
    n.stateNode === null)
        ...
        var s = u.context
          , c = t.contextType;
        typeof c == "object" && c !== null ? c = Ce(c) : (c = fe(t) ? xn : re.current,
        c = qn(n, c));
        ...
        Qr(n, r, u, l),
        s = n.memoizedState,
        i !== r || p !== s || ce.current || Je ? (typeof h == "function" && (Co(n, t, h, r),
        s = n.memoizedState),
        ...
        p = u.context,
        s = t.contextType,
        typeof s == "object" && s !== null ? s = Ce(s) : (s = fe(t) ? xn : re.current,
        s = qn(n, s));
        var g = t.getDerivedStateFromProps;
        (h = typeof g == "function" || typeof u.getSnapshotBeforeUpdate == "function") || typeof u.UNSAFE_componentWillReceiveProps != "function" && typeof u.componentWillReceiveProps != "function" || (i !== m || p !== s) && Si(n, u, r, s),
        Je = !1,
        p = n.memoizedState,
        u.state = p,
        Qr(n, r, u, l);
        var w = n.memoizedState;
        i !== m || p !== w || ce.current || Je ? (typeof g == "function" && (Co(n, t, g, r),
        w = n.memoizedState),
...
function No(e, n, t, r, l, o) {
    ...
    n.child = et(n, null, i, o)) : le(e, n, i, o),
...
function sd(e, n, t) {
    ...
    case 13:
        ...
        r !== null)
            ...
            n.flags |= 128,
            null) : t & n.child.childLanes ? Da(e, n, t) : (O(U, U.current & 1),
            e = Ye(e, n, t),
                ...
                e: {
                    ...
                    for (o in i)
                        if (i.hasOwnProperty(o)) {
                            ...
                            s != null && ds(e, s)) : o === "children" ? typeof s == "string" ? (t !== "textarea" || s !== "") && Mt(e, s) : typeof s == "number" && Mt(e, "" + s) : o !== "suppressContentEditableWarning" && o !== "suppressHydrationWarning" && o !== "autoFocus" && (Rt.hasOwnProperty(o) ? s != null && o === "onScroll" && D("scroll", e) : s != null && Qo(e, o, s, u))
                        }
                    switch (t) {
                    case "input":
                        rr(e),
                        ...
                        case 1:
                            if (w !== null) {
                                var S = w.memoizedProps
                                  , I = w.memoizedState
                                  , f = n.stateNode
                                  , a = f.getSnapshotBeforeUpdate(n.elementType === n.type ? S : Ne(n.type, S), I);
            ...
            s !== null)
                try {
                    ...
                    for (u = 0; u < s.length; u += 2) {
                        var h = s[u]
                          , m = s[u + 1];
                        h === "style" ? ms(l, m) : h === "dangerouslySetInnerHTML" ? ds(l, m) : h === "children" ? Mt(l, m) : Qo(l, h, m, c)
                    }
                    switch (i) {
                    case "input":
                        ql(l, o);
...
function an(e) {
    return e.mode & 1 ? R & 2 && q !== 0 ? q & -q : Jf.transition !== null ? (zr === 0 && (zr = Ps()),
    zr) : (e = M,
    e !== 0 || (e = window.event,
        ...
        if (n === 6)
            ...
            case 3:
                ...
                10 < n)) {
                    ...
                    e.timeoutHandle = yo(wn.bind(null, e, se, Ue), n);
                    break
                }
                wn(e, se, Ue);
                break;
            case 4:
                ...
                10 < r) {
                    e.timeoutHandle = yo(wn.bind(null, e, se, Ue), r);
                    break
                }
                wn(e, se, Ue);
                break;
...
Za = function(e, n, t) {
    if (e !== null)
        ...
        ae = !1,
        j && n.flags & 1048576 && bs(n, Br, n.index);
    switch (n.lanes = 0,
    n.tag) {
    case 2:
        var r = n.type;
        ...
        e: {
            ...
            o.isDehydrated)
                ...
                n.flags & 256) {
                    ...
                    for (me = on(n.stateNode.containerInfo.firstChild),
                    he = n,
                    j = !0,
                    Le = null,
                    t = ia(n, null, r, t),
...
const Rd = ()=>{
    let e = 522
      ...
      , r = window.innerWidth == 1366;
    t ? (e = 458,
    n = 120) : r && (e = 458,
    n = 620);
    const [l,o] = Tt.useState(e)
      , [u,i] = Tt.useState(n)
      , s = ()=>{
        const h = window.innerHeight
          , m = window.innerWidth;
        let p = Math.random() * (h - 50)
          , g = Math.random() * (m - 200);
        t ? (p = Math.min(p, h - 50),
        p = Math.max(p, 0),
        g = Math.min(g, m - 220),
        g = Math.max(g, 0)) : (g = Math.min(g, m - 100),
        p = Math.max(p, 0)),
        o(p),
        i(g)
    }
...
;
function Md() {
    const e = ["https://i.pinimg.com/1200x/7d/3c/d6/7d3cd65da2182b47531a82c7391c97c0.jpg" , "https://www.youtube.com/watch?v=ymdhRMiMGK0", "https://www.youtube.com/watch?v=Kyl01V1EWC8", "https://youtu.be/XYu__CE4u-M", "https://youtu.be/rew8ZFfoHks", "https://youtu.be/FenNwYo-miw?t=15", "https://youtu.be/5uAVvo9ZU9Y", "https://youtu.be/fK9nofPKpoc?t=64"]
      , n = ()=>{
...
Ql.createRoot(document.getElementById("root")).render($e.jsx(wc.StrictMode, {
    children: $e.jsx(Md, {})
}));
